...
export class DialogEditNotesComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<DialogEditNotesComponent>, private router: Router, private firestore: Firestore = inject(Firestore)) {}
